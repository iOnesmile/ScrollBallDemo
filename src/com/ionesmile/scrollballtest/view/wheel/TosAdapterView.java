...
public abstract class TosAdapterView<T extends Adapter> extends ViewGroup {
    ...
    private void fireOnSelected() {
        Log.i("myTag", "--- fireOnSelected() mOnItemSelectedListener == null " + (mOnItemSelectedListener == null));
        if (mOnItemSelectedListener == null) {
            return;
        }

       // Log.i("myTag", "--- fireOnSelected() getSelectedItemPosition() " + getSelectedItemPosition());
