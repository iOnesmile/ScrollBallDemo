...
//        this.mSelectorDrawable = getContext().getResources().getDrawable(R.drawable.smile_wheel_val);
...
//        drawShadows(canvas);
    ...
    /**
     * @see
     * //com.smile.wheel.nj1s.lib.widget.TosGallery#setSelectedPositionInt(int)
     */
    @Override
